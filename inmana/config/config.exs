...
config :inmana, Inmana.Mailer, adapater: Bamboo.LocalAdapter

# Configures the endpoint
config :inmana, InmanaWeb.Endpoint,
  url: [host: "localhost"],
  secret_key_base: "URgFo3c46ykbF8Eg2wZYG7unXWJzS3sgEC1w6mrA9WQJtWWvSgR8gaXvzBipGA+D",
  render_errors: [view: InmanaWeb.ErrorView, accepts: ~w(json), layout: false],
  pubsub_server: Inmana.PubSub,
  live_view: [signing_salt: "fBDRPESz"]
